...
bot(
  ...
  async (message) => {
    ...
    var sn;
    if (HANDLERS == "null") sn = "";
    else sn = HANDLERS.split("")[0] 
    const prefix = HANDLERS !== "null" ? HANDLERS.split("")[0] : "";
    const buttons = [
      {buttonId: sn + 'setvar MODE:public', buttonText: {displayText: 'Public'}, type: 1},
      {buttonId: sn + 'setvar MODE:private', buttonText: {displayText: 'Private'}, type: 1}
    ]
